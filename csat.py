...
def CalcNotas(df):
  ...
  return CalcNotas.IQT, CalcNotas.NotaFinalSalgado, CalcNotas.NotaSalgado, CalcNotas.DesvPAD_Salgado, CalcNotas.NotaFinalRefri, CalcNotas.NotaRefri, CalcNotas.DesvPAD_Refri, CalcNotas.NotaFinalBolo, CalcNotas.NotaBolo, CalcNotas.DesvPAD_Bol
...
st.write(df)
IQT, NFS, NS, DPS, NFR, NR, DPR, NFB, NB, DPB = CalcNotas(df)
st.write("Índice de Qualidade da Taioba = ", IQT)
st.write("Nota Final Salgado = ", NFS)
st.write("Nota Final Refri = ", NFR)
st.write("Nota Final Bolo = ", NFB)
st.write("Desvio Padrão Salgado = ", DPS)
st.write("Desvio Padrão Refri = ", DPR)
st.write("Desvio Padrão Bolo = ", DPB)
